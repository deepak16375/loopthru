  ...
  return (
    ...
    >
      <div className="relative w-72 md:w-96 h-auto rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105">
        ...
        <div className="absolute inset-0 flex items-end justify-center opacity-0 hover:opacity-80 transition-opacity duration-300">
          <div className="w-full h-1/2 bg-gradient-to-t from-[#FFD53D] to-black flex items-center justify-center text-white">
