...
const cardData: CardData[] = [
  ...
  { imageSrc: "/websitedev.jpeg", title: "Website Development", description: "Our Website Development service focuses on turning your vision into a vibrant reality. We create websites that reflect your goals and drive your success, blending creativity with functionality to achieve your unique objectives." },
  ...
  { imageSrc: "/videoproduction.jpeg", title: "Video Production", description: "Our Video Production service is dedicated to bringing our clients' vision to life, ensuring they achieve the best possible results. We focus on every detail, from concept to execution to create impactful, high-quality content that resonates with their target audience." },
  { imageSrc: "/SMM.jpeg", title: "Social Media Management", description: "Our Social Media Management service is focused on crafting tailored strategies, managing content, and engaging with audiences to maximize online presence and drive meaningful growth for our clients' brands.Create stunning visual designs!" }
];
